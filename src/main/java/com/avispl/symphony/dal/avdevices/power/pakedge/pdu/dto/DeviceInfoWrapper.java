...
/**
 * WapperDTO class provides during the monitoring and controlling process
 *
...
public class DeviceInfoWrapper {
	...
	private DeviceInfoResponse response;
	 ...
	 */
	public DeviceInfoResponse getResponse() {
		return response;
	}
	 ...
	 * Sets {@code response}
	 *
	 * @param response the {@code com.avispl.symphony.dal.avdevices.power.pakedge.pdu.dto.deviceinfo.DeviceInfoResponse} field
	 */
	public void setResponse(DeviceInfoResponse response) {
